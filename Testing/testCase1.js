// This is a test case to load the Home Page
describe("Go to the Homepage ", function(){
  ...
  it("Go to the Home page ", function(){
    browser.get("http://localhost:4200/auth/login"); // Go to a specific URL
    console.log("Home Page Open succesffully")
    browser.sleep(5000) // browser to sleep for 25 seconds
  });
